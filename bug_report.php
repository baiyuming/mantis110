<?php
	...
	/*$employeeids = gpc_get_string( 'employeeids' );
	if ( $employeeids != null && $employeeids != "" ) {
		$data = array (
		    'mode' => "sendNotify",
		    'fromip' => "127.0.0.1",
		    'employeeids' => $employeeids,
		    "msg" => iconv("UTF-8","GBK",$t_bug_data->description),
		    "title" => iconv("UTF-8","GBK",$t_bug_data->summary)
	  ); 
 	
 	  $client = new HttpClient();
 	  $client->HttpRequest("http://192.168.100.125:9999/rtx.do","POST",$data);
	}
  */
