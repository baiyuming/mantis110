<?php
	...
	function html_top_banner() {
		...
		if ( !is_blank( $t_page ) && file_exists( $t_page ) && !is_dir( $t_page ) ) {
			...
			echo '<a href="http://www.qianmi.com" title="Free Web Based Bug Tracker" target="_blank"><img border="0" width="242" height="102" alt="Matis qianmi" src="images/qianmi.png" /></a>';
			echo '</div>';
		}
	}
	...
	function html_footer( $p_file ) {
		...
		if ( ON == config_get( 'show_version' ) ) {
			echo "\t", '<span class="timer"><a href="http://www.qianmi.com/" title="Free Web Based Bug Tracker" target="_ablank">Mantis ', config_get( 'mantis_version' ), '</a>',
					'[<a href="http://www.qianmi.com/"  title="Free Web Based Bug Tracker" target="_blank">^</a>]</span>', "\n";
		}
		...
		echo '<a href="http://www.qianmi.com" title="Free Web Based Bug Tracker" target="_ablank"><img src="images/mantis_logo_button.gif" width="88" height="35" alt="Powered by Mantis Bugtracker" border="0" /></a>';
